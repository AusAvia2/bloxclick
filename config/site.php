...
return [
    'storage' => [
        ...
        'pending' => [
            ...
            'set' => env('STORAGE_DOMAIN', 'http://bloxworld.s3-website-ap-southeast-2.amazonaws.com') . env('STORAGE_PENDING_SET', '/default/pendingset.png'),
        ],
        'declined' => [
            '512' => env('STORAGE_DOMAIN', 'http://bloxworld.s3-website-ap-southeast-2.amazonaws.com') . env('STORAGE_DECLINED_512', '/default/declined.png'),
            'set' => env('STORAGE_DOMAIN', 'http://bloxworld.s3-website-ap-southeast-2.amazonaws.com') . env('STORAGE_DECLINED_SET', '/default/declinedset.png'),
        ],
        'avatars' => env('STORAGE_DOMAIN', 'http://bloxworld.s3-website-ap-southeast-2.amazonaws.com') . env('STORAGE_AVATARS_LOC', '/images/avatars/'),
        'items' => env('STORAGE_DOMAIN', 'http://bloxworld.s3-website-ap-southeast-2.amazonaws.com') . env('STORAGE_ITEMS_LOC', '/v2/images/shop/thumbnails/'),
