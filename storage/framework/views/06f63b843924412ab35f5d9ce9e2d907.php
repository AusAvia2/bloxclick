            ...
            <div class="tab-body active" data-tab="1">
                <div class="content" style="padding:0px">
                    ...
                    <a href="/message/<?php echo e($message->id); ?>/">
                        <div class="hover-card thread-card m0 <?php echo e(($message->read) ? '' : 'viewed'); ?>">
                            <div class="col-7-12 topic">
                                <span class="small-text label dark"><?php echo e($message->title); ?></span><br>
                                <span class="label smaller-text" data-user-id="<?php echo e($message->sender->id); ?>">From <span class="darkest-gray-text"><?php echo e($message->sender->username); ?></span></span>
                            </div>
    ...
    <div class="pages">
        <?php if(isset($page['pages'])): ?>
            <?php $__currentLoopData = $page['pages']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pageNum): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a class="page <?php if($page['current'] == $pageNum): ?> active <?php endif; ?>" href="/messages/<?php echo e($pageNum); ?>"><?php echo e($pageNum); ?></a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>
    </div>
</div>
