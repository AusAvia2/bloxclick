...
<div class="download-page">
    <div class="main-holder grid holder legacy">
        <div style="margin-bottom:10px;">
            ...
            <a href="<?php echo e(config('site.storage.domain')); ?>/downloads/BrickHillSetup.exe" class="download" style="width:100%;">
                <button class="orange">
    ...
    <div class="holder experimental">
        <div class="main-holder grid">
            ...
            <download-client 
                id="downloadclient-v"
                latest="<?php echo e($latestVersion); ?>"
                :authed="<?php echo e(Auth::check() ? "true" : "false"); ?>"
                :has-bought="<?php echo e(Auth::user()?->clientAccess()->exists() || Auth::user()?->is_beta_tester ? "true" : "false"); ?>"
            ></download-client>
        </div>
    </div>
